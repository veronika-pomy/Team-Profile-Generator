...
test('getName function returns the passed name argument', ( ) => {
    expect(employee.getName()).toBe('Veronika');
});

test('getId function returns the passed id argument', ( ) => {
    expect(employee.getId()).toBe('77777');
});

test('getEmail function returns the passed email argument', ( ) => {
